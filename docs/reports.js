reports =[
    ...
    ["15", "Presented our demo in class on Thursday. Continued work on SRS document and testing document. Updated team website to include links to the SRS and testing document.", "Finish up both the SRS and testing document. Prepare our final zip submission with all the required documents. Ensure seankbanerjee is in our github repo and if not send another invite.", "Met for a total of 1 hour this week"],
]
