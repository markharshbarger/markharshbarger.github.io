reports =[
    ["1", "Over the course of this week we created a github repo and discord. We've begun researching frameworks and discussing requirements. We met up with the team and discussed upcoming meeting times.", "During the next week, our group plans to research frameworks and databases that would fit the function of the project.", "Met 1 time for an hour"],
